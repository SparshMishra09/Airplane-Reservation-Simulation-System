...
export default function AdminPage() {
  ...
  if (isAdmin === null) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4 bg-gradient-to-b from-secondary/40 to-background">
  ...
  return (
    <>
      ...
      <main className="relative mx-auto max-w-7xl px-4 py-10 md:px-6">
        <div className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(ellipse_80%_40%_at_50%_-10%,oklch(0.45_0.12_260/0.12),transparent_55%)]" />
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        >
          <p className="text-xs font-semibold uppercase tracking-widest text-primary">Operations</p>
          <h1 className="text-3xl font-bold mb-2 md:text-4xl">Admin dashboard</h1>
          <p className="text-muted-foreground mb-8 max-w-2xl text-sm">
            Manage flights, view analytics, and schedule new routes (demo data shown).
          </p>
        </motion.div>
        ...
        <div className="flex flex-wrap gap-2 mb-8">
          {(
            ...
            <button
              ...
              className={`rounded-full px-5 py-2.5 text-sm font-semibold transition-all duration-300 ${activeTab === key
                  ? "bg-primary text-primary-foreground shadow-lg shadow-primary/25"
                  : "bg-card text-secondary-foreground border border-border/60 hover:bg-secondary/80"
                }`}
            >
              {label}
            </button>
        ...
        {activeTab === "overview" && (
          ...
          >
            ...
            <div className="rounded-3xl bg-white/95 border border-border/70 p-6 shadow-lg ring-1 ring-black/[0.03]">
        ...
        {activeTab === "flights" && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <div className="rounded-3xl bg-white/95 border border-border/70 shadow-lg ring-1 ring-black/[0.03] overflow-hidden">
        ...
        {activeTab === "add" && (
          <motion.div
            ...
            className="max-w-2xl"
          >
            <div className="rounded-3xl bg-white/95 border border-border/70 p-8 shadow-lg ring-1 ring-black/[0.03]">
              ...
              <button type="button" className="btn-airline-primary mt-6 w-full py-3.5">
                Schedule Flight
              </button>
            </div>
          </motion.div>
